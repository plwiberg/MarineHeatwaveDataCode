---
title: "SST MHW Simulations - COCOI"
output:
  html_document:
    df_print: paged
...
This analysis is focused on modeling effects of trends in SST mean and variance following Oliver 2019. This record is from the OISST-V2.1 gridded daily SST dataset at the former NOAA NDBC CHLV2 site, east of the mouth of Chesapeake Bay. The record extends from 1982-2021 (40 years).

This block reads in data.

```{r}
library(lubridate)
XDdf=read.csv("SST_COC_CBW_Aug2023.csv") 
Xts=XDdf$COCOI #COCOI daily SST
dt=mdy(XDdf$dt)
dd=decimal_date(dt)
